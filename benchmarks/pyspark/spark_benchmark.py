...
if __name__ == "__main__":
    import optparse
    num_records = 100000000#0
    parser = optparse.OptionParser(usage="Usage: %prog [options] test_names")
    parser.add_option("--num-trials", type="int", default=3)
    parser.add_option("--reduce-tasks", type="int", default=24)
    parser.add_option("--num-records", type="int", default=num_records)
    parser.add_option("--inter-trial-wait", type="int", default=0)
    parser.add_option("--unique-keys", type="int", default=100000)
    parser.add_option("--key-length", type="int", default=10)
    parser.add_option("--unique-values", type="int", default=10212)
    parser.add_option("--value-length", type="int", default=90)
    parser.add_option("--num-partitions", type="int", default=24)
